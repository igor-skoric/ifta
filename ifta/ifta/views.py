...
from core.security import statistics_tv_or_permission_required

@permission_required("ifta.view")
...
@permission_required("ifta.manage_uploads")
...
def weekly_analytics(request):
    ...
    return render(
        request,
        "statistics/weekly_analytics.html",
        {"hide_header_and_footer": False},
    )
...
def people_inventory(request):
    return redirect("office:people_inventory")